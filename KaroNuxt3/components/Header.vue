    ...
    <div class="header-desktop">
      <div class="header-desktop-left-column">
        ...
        <div class="menu-items-list">
          ...
          <div class="menu-item font-menu-items">
            Mua nhà
            <span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
      ...
      <!-- <div class="header-desktop-right-column">
  ...
  .header-desktop {
      ...
      .menu-items-list {
        ...
        .menu-item {
          ...
          .dropdown-menu {
            ...
            border-radius: 8px;
            box-shadow: 0 10px 10px 0 rgba(10, 40, 85, 0.1);
            margin: 0;
            z-index: 2;
    ...
    .header-desktop-right-column {
      ...
      .login-btn {
        ...
        gap: 10px;
        border-radius: 8px;
        border: 1px solid var(--Red-Primary, #ec1f25);
        background: #fff;
        color: var(--Red-Primary, #ec1f25);
        text-align: center;
        font-family: Plus Jakarta Sans;
        font-size: 16px;
        font-style: normal;
      ...
      .manage-btn {
        ...
        gap: 10px;
        border-radius: 8px;
        background: var(--Blue-2nd, #002f7a);
        color: #fff;
        text-align: center;
        font-family: Plus Jakarta Sans;
        font-size: 16px;
      ...
      .notify-btn {
        ...
        gap: 10px;
        border-radius: 8px;
        border: 1.5px solid var(--BG-Light-Blue, #f5f9ff);
        background: var(--BG-Light-Blue, #f5f9ff);
      }
      ...
      .user-info {
        ...
        gap: 14px;
        border-radius: 8px;
        border: 1.5px solid var(--Border-Blue, #e6f0ff);
        position: relative;
